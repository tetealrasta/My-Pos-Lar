...
<div class="row">
    <div class="col-sm-4">
        <h5><strong>إسم المتحصل</strong> : {{$data->get_mot->Mo_Name}}</h5>
    </div>
    <div class="col-sm-3">
        <h5><strong>عنوان المتحصل</strong> : {{$data->get_mot->Mo_Address}}</h5>
    </div>
    <div class="col-sm-3">
        <h5><strong>رقم هاتف المتحصل</strong> : {{$data->get_mot->Mo_Phone}}</h5>
    </div>
    <div class="col-sm-2">
        <h5><strong>ايميل المتحصل</strong> : {{$data->get_mot->Mo_Email}} </h5>
    </div>
